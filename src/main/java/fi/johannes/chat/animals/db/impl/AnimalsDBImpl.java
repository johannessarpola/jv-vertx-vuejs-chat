package fi.johannes.chat.animals.db.impl;
 ...
 */
public class AnimalsDBImpl implements AnimalsRepository {

  public AnimalsDBImpl() {
  }

  public List<Animal> getAnimals() {
    return animals.parallelStream().map(Animal::new).collect(Collectors.toList());
  }
